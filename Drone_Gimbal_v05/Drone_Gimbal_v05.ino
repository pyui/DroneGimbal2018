/* =====================================================================================
    ...
    Arturo Guadalupi and Michael Shiloh: https://www.arduino.cc/en/Tutorial/StringToFloatExample
   =====================================================================================
*/
...
void setup()
{
  ...
  Serial.println("LABEL, TIME, TIMER, NetYaw, YawStep, NetPitch, PitchStep, NetYawLeica, NetPitchLeica, NetYawIMU, NetPitchIMU");
...
void loop() {
  ...
  if (flag) {
    ...
    if (fifoCount == 1024) {
      ...
      netYawLeica = (float)(random(-1000, 1000) / 100.00);
      netPitchLeica = (float)(random(-1000, 1000) / 100.00);
      ...
      Serial.print(",");
      Serial.print(netYawLeica);
      Serial.print(",");
      Serial.print(netPitchLeica);
      Serial.print(",");
