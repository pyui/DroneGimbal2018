/* =====================================================================================
    ...
    The code uses some aspects of Jeff Rowberg's MPU6050_DMP6 demo code
   =====================================================================================
*/
// ================================================================
// ===               IMU DEFINITIONS                            ===
...
// View the yaw/pitch/roll angles (in degrees) calculated from the quaternions coming
...
// ===                      STEP FUNCTION                       ===
// ================================================================
void step(boolean dir, int steps, unsigned long period) {
  ...
  for (int i = 0; i < steps; i++) {
    ...
    delayMicroseconds(period); //defines speed, nominally 100(fast) -> 1000(slow)
    digitalWrite(stepperPin1, LOW);
    digitalWrite(stepperPin2, LOW);
    delayMicroseconds(period); //defines speed
  }
}
